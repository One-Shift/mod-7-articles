<form class="tacenter" action="{c2r-path-bo}/{c2r-lg}/{c2r-module-folder}/delete/{c2r-id}" method="post">
	<p>{c2r-phrase}</p>
	...
	<a href="{c2r-path-bo}/{c2r-lg}/articles/" class="btn btn-warning btn-edit" role="button">
